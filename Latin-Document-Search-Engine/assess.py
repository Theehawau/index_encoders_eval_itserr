...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir",
                        ...
                        help="Directory to access files")
    ...
    k = args.top_k
    # data_path = f"target_random1k_data/{args.index_model}_index/Latin_benchmark_best_targets.txt"
    data_path = f"{args.save_dir}/Latin_benchmark_best_targets.txt"
    ...
    # out_dir = f"target_random1k_data/{args.index_model}_index/_outputs_*"
    out_dir = f"{args.save_dir}/_outputs_*"
    cos_similarity_path = f"{out_dir}/Latin_benchmark_best_cosine_similarities.txt"
