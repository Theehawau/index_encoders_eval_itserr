...
def get_config():
    ...
    model.tokenizer = 'bowphs/GreBerta' # 'bowphs/GreBerta', 'bowphs/PhilBerta', "/home/hawau/PhilBERTa_MLM_final2"
    ...
    index.index_path = "/home/hawau/greek_target_random1k/"
    index.index_name ="Faiss_Greek_{0}"

    config.db = db = ConfigDict()
    db.db_path = "/home/hawau/greek_target_random1k/"
    db.db_name ="DB_Greek_{0}"
